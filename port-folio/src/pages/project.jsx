        ...
        <div className='section'>
            <section ref={projectRef} id='projectContainer'>
                ...
                <div className="flex items-center justify-center flex-col">
                    <h4 className="mt-10 text-xl md:text-4xl font-medium leading-snug text-indigo-500">MES PROJETS</h4>
                    <p className="mt-2 text-xl font-medium leading-snug text-black dark:text-white">Les projets sur lesquels j'ai travaillé</p>
                </div>
